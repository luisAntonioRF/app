...
/**
 * Handles the creation of table `{{%denied_auth_invalid_pin}}`.
 */
class m250603_213848_create_denied_auth_invalid_pin_table extends Migration
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $this->createTable('{{%denied_auth_invalid_pin}}', [
            'id' => $this->primaryKey(),
    ...
    {
        $this->dropTable('{{%denied_auth_invalid_pin}}');
    }
}
