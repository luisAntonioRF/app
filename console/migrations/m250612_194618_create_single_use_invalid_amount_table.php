...
/**
 * Handles the creation of table `{{%single_use_invalid_amount}}`.
 */
class m250612_194618_create_single_use_invalid_amount_table extends Migration
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $this->createTable('{{%single_use_invalid_amount}}', [
            'id' => $this->primaryKey(),
    ...
    {
        $this->dropTable('{{%single_use_invalid_amount}}');
    }
}
