...
/**
 * Handles the creation of table `{{%denied_auth_nsf}}`.
 */
class m250602_190601_create_denied_auth_nsf_table extends Migration
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $this->createTable('{{%denied_auth_nsf}}', [
            'id' => $this->primaryKey(),
    ...
    {
        $this->dropTable('{{%denied_auth_nsf}}');
    }
}
