...
/**
 * Handles the creation of table `{{%denied_auth}}`.
 */
class m250602_195703_create_denied_auth_table extends Migration
{
    /**
     * {@inheritdoc}
     */
    public function safeUp()
    {
        $this->createTable('{{%denied_auth}}', [
            ...
            'financial_network_code' => $this->string(2),
            ...
            'mc_installment_pmt_data' => $this->string(20),
            'mc_promotion_code' => $this->string(40),
            'mcc' => $this->string(20),
            ...
            'token_requester_id' => $this->string(20),
