...
/**
 * Handles the creation of table `{{%greendot_auth}}`.
 */
class m250602_223020_create_greendot_auth_table extends Migration
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $this->createTable('{{%greendot_auth}}', [
            'id' => $this->primaryKey(),
