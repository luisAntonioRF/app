...
/**
 * Handles the creation of table `{{%denied_auth_inactive_card}}`.
 */
class m250603_222220_create_denied_auth_inactive_card_table extends Migration
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $this->createTable('{{%denied_auth_inactive_card}}', [
            'id' => $this->primaryKey(),
    ...
    {
        $this->dropTable('{{%denied_auth_inactive_card}}');
    }
}
