...
/**
 * Handles the creation of table `{{%greendot_auth_failure}}`.
 */
class m250602_225949_create_greendot_auth_failure_table extends Migration
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $this->createTable('{{%greendot_auth_failure}}', [
            'id' => $this->primaryKey(),
    ...
    {
        $this->dropTable('{{%greendot_auth_failure}}');
    }
}
