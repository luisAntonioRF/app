...
/**
 * Handles the creation of table `{{%auth_fallback}}`.
 */
class m250603_235017_create_auth_fallback_table extends Migration
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $this->createTable('{{%auth_fallback}}', [
            'id' => $this->primaryKey(),
            'act_type' => $this->string(3)->notNull(),
            'amount' => $this->decimal(12,2),
            'auth_api_request' => $this->text(),
