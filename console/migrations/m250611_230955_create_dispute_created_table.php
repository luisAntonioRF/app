...
/**
 * Handles the creation of table `{{%dispute_created}}`.
 */
class m250611_230955_create_dispute_created_table extends Migration
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $this->createTable('{{%dispute_created}}', [
            'id' => $this->primaryKey(),
    ...
    {
        $this->dropTable('{{%dispute_created}}');
    }
}
