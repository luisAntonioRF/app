...
/**
 * Handles the creation of table `{{%profile_changed}}`.
 */
class m250612_222835_create_profile_changed_table extends Migration
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $this->createTable('{{%profile_changed}}', [
            'id' => $this->primaryKey(),
    ...
    {
        $this->dropTable('{{%profile_changed}}');
    }
}
