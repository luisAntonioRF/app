...
/**
 * Handles the creation of table `{{%card_returned}}`.
 */
class m250613_062906_create_card_returned_table extends Migration
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $this->createTable('{{%card_returned}}', [
            'id' => $this->primaryKey(),
