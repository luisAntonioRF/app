...
/**
 * Handles the creation of table `{{%card_expiring}}`.
 */
class m250613_065634_create_card_expiring_table extends Migration
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $this->createTable('{{%card_expiring}}', [
            'id' => $this->primaryKey(),
